# -*- encoding: utf-8 -*-
require File.expand_path('../lib/omniauth-v2-shibboleth-provider/version', __FILE__)
...
Gem::Specification.new do |gem|
  ...
  gem.description   = %q{OmniAuth Shibboleth provider strategies for OmniAuth 2.x}
  gem.summary       = %q{OmniAuth v2 Shibboleth provider}
  gem.homepage      = "https://github.com/aguerson/omniauth-v2-shibboleth-provider"

  gem.files         = `find . -not \\( -regex ".*\\.git.*" -o -regex "\\./pkg.*" -o -regex "\\./spec.*" \\)`.split("\n").map{ |f| f.gsub(/^.\//, '') }
  gem.test_files    = `find spec/*`.split("\n")
  gem.name          = "omniauth-v2-shibboleth-provider"
